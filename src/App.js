...
class App extends Component {
	...
	render() {
		...
		return (
			<div className='app'>
				<h1 className='page-header_title risetext heading'>
				...
				<div className='pannel'>
					...
					/>
					<div>
					<h1 style={{textAlign:'center',fontSize:'40px',color: "red",marginTop:'0px'}}>Time Complexities</h1>
					<Compcard
						formLabel='Time-Complexities'
					/>
					{/* <Form
						formLabel='Speed'
